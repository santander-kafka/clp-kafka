...
@NoArgsConstructor
@Getter
public class ClpProductRelationsPersistedEvent extends ClpProductRelationsEvent {
    @Builder.Default
    ...
    @Builder.Default
    private ProductEventType type = ProductEventType.PRODUCT_RELATIONS_PERSISTED;
